...
(() => {
  const PLAN_KEY='saveEarnPaulV5Plan', OS_KEY='saveEarnPaulV5OS';
  const defaultOS=()=>({version:'5.0',tasks:[],documents:[],consent:{energy:true,broadband:true,mobile:true,earning:false,tasks:true,documents:false},updatedAt:new Date().toISOString()});
