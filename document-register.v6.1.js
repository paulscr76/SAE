...
(() => {
  ...
  button.addEventListener('click',()=>{
    ...
    let os={version:'6.1',tasks:[],documents:[],consent:{}};
    try{os={...os,...(JSON.parse(localStorage.getItem('saveEarnPaulV6OS'))||{})};}catch(_){}
    ...
    localStorage.setItem('saveEarnPaulV6OS',JSON.stringify(os));
