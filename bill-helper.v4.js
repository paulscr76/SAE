(() => {
  ...
  document.getElementById('saveBill').addEventListener('click',()=>{
    ...
    let state={};try{state=JSON.parse(localStorage.getItem('saveEarnPaulV4Plan'))||JSON.parse(localStorage.getItem('saveEarnPaulV31Plan'))||JSON.parse(localStorage.getItem('saveEarnPaulV3Plan'))||{};}catch(_){}
    ...
    localStorage.setItem('saveEarnPaulV4Plan',JSON.stringify(state));
