...
(() => {
  ...
  const samplePlan={
    version:'6.2',householdName:'The Example household',postcode:'BN21 1AA',priority:'both',propertyType:'semi',bedrooms:'3',occupants:'3',heating:'gas',efficiency:'average',daytime:'mixed',
