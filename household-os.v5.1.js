...
(() => {
  ...
  const defaultOS=()=>({version:'5.1',tasks:[],documents:[],consent:{energy:true,broadband:true,mobile:true,insurance:true,earning:false,tasks:true,documents:false},updatedAt:new Date().toISOString()});
