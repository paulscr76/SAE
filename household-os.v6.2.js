...
(() => {
  ...
  const defaultOS=()=>({version:'6.2',tasks:[],documents:[],consent:{energy:true,broadband:true,mobile:true,insurance:true,earning:false,tasks:true,documents:false},updatedAt:new Date().toISOString()});
  ...
  if(!plan&&document.documentElement.dataset.demo==='true'){
    plan={
      version:'6.2',householdName:'The Example household',postcode:'BN21 1AA',priority:'both',
