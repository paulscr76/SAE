...
(() => {
  ...
  button.addEventListener('click',()=>{
    ...
    let os={version:'4.0',tasks:[],documents:[],consent:{}};
    try{os={...os,...(JSON.parse(localStorage.getItem('saveEarnPaulV4OS'))||{})};}catch(_){}
    ...
    localStorage.setItem('saveEarnPaulV4OS',JSON.stringify(os));
