(() => {
  ...
  document.getElementById('saveBill').addEventListener('click',()=>{
    ...
    state.version='6.3';state.meta={...(state.meta||{}),updatedAt:new Date().toISOString()};state.energyMode='actual';if(e)state.actualElectric=String(e);if(g)state.actualGas=String(g);
