...
(() => {
  ...
  const samplePlan={
    version:'5.1',priority:'both',propertyType:'semi',bedrooms:'3',occupants:'3',heating:'gas',efficiency:'average',daytime:'mixed',
  ...
  function footer(page,total,title){
    return `<div class="report-page-footer"><span><strong>Save &amp; Earn with Paul v5.1</strong> • ${esc(title)}</span><span>Confidential household planning document • Page ${page} of ${total}</span></div>`;
  }
