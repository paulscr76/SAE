...
const CACHE='save-earn-v3-0';
const STATIC=['/styles.v3.css','/site.v3.js','/analytics.v3.js','/command-centre.v3.js','/bill-helper.v3.js','/calculator.v3.js','/guides.v3.js','/paul-scrase-480.webp','/paul-scrase-800.webp','/social-share.webp','/favicon.svg','/manifest.webmanifest','/icon-192.png','/icon-512.png'];
