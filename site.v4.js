...
// Version 4.0 local-first preferences and migration
(() => {
  const PREF_KEY = 'saveEarnPaulV4Preferences';
  const PLAN_KEY = 'saveEarnPaulV4Plan';
  const legacyKeys = ['saveEarnPaulV31Plan','saveEarnPaulV3Plan'];
